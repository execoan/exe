...
def plotColor(redExp, greenExp, blueExp, pixelsPerUnit = 300):
...
def makeImage(numPics = 5):
   ...
   with open("eqns.txt", 'w') as eqnsFile:
      for i in range(numPics):
         ...
         image = plotColor(redExp, greenExp, blueExp,pixelsPerUnit=300)
         image.save(file+'/'+("img" + str(i) + ".png"), "PNG",dpi=(600, 600))
